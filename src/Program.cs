...
public class Program
{
    ...
    static void ClearWorkingDirectory()
    {
        ...
        {
            if (Path.GetFileName(file) != ".git") // Basic check, might need refinement
            {
    ...
    static void CheckoutTree(string treeHash, string basePath)
    {
        ...
        while (currentPos < treeRawData.Length)
        {
            ...
            else // File (modes like 100644, 100755, 120000 for symlinks)
            {
                ...
                try
                {
                    ...
                    // TODO: Handle file modes (e.g., set executable bit for 100755 on Unix-like systems)
